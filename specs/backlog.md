...
- app_streamlit.obter_previsao: as URLs foram construídas com chaves literais dentro de f-strings:
- url_cidade = f".../{{nome_cidade}}"
- url_previsao = f".../{{codigo_cidade}}"

No caso da AS do aluno Brenoall